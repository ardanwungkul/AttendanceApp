<x-app-layout>
    ...
    <div class="py-4">
        <form action="{{ route('karyawan.store') }}" class="grid grid-cols-2 gap-x-8 gap-y-6" method="POST">
            @csrf
            @method('POST')
            <div>
            ...
            <div>
                ...
                <x-text-input id="tempat_lahir" class="block mt-1 w-full" type="text" name="tempat_lahir"
                    :value="old('tempat_lahir')" required autofocus autocomplete="tempat_lahir"
            ...
            <div>
                ...
                <x-text-input id="no_rekening" class="block mt-1 w-full" type="text" name="no_rekening"
                    :value="old('no_rekening')" autofocus autocomplete="no_rekening" placeholder="Masukkan No Rekening" />
